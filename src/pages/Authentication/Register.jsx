...
const Register = () => {
  return (
    <Box display='flex' mt={20} w='100%'  borderRadius='lg' overflow='hidden' >
        <Box alignItems='baseline' w='50%'  bgGradient='linear(white 0%, orange.100 50%)'>
            <Stack>
                <Center>
                    <Text fontSize='3xl' as='b' mt={10} mb={-7} letterSpacing={2}>Welcome to the world of Bewakoof®!</Text>
                </Center>
            </Stack>
            <Center>
                <Image bg='transparent' mt={32} p='8'   src='https://images.bewakoof.com/web/group-19-1617704502.png' alt='img' w='95%' h='442'/>
            </Center>
        </Box>
        <Box w='50%'>
            <Grid textAlign='center' mt={12}  letterSpacing={1}>
            ...
            <Box  mt='20'>
                <Box w='55%' display='flex' gap='4' m='auto' border='1px solid #a0a0a0' p='3' borderRadius='5'>
                    ...
                    <Input variant='unstyled' placeholder='Enter Mobile Number' _placeholder={{ opacity: 20, color: 'grey', fontWeight:'bold', fontSize:'20' }}  />
                    {/* Added field required alert msg */}
                </Box>
                <Box w='55%' m='auto' mt='4'>
                    <Button w='100%' bg='#42a2a2' color='white' p='30' fontSize='22' letterSpacing={1}>CONTINUE</Button>
                </Box>
                ...
                <Box m='auto' mt='5' display='flex' gap='2' w='55%' mb='7'>
