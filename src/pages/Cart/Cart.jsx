              ...
              >
                <Box display="flex" justifyContent="space-around" mb="5">
                  <Box w="100%" letterSpacing={0.8}>
                    ...
                    <Text color="#1d8802" mb="5">
                      You saved ₹{Math.floor(el.price / 8)}!
                    </Text>
        ...
        <Box w="40%" m="auto" mt="0">
          <Box mt="12" p="3" bg="#fdd835" borderRadius="6">
            <Text letterSpacing={0.8}>
              Save extra <span style={{ fontWeight: "bold" }}>₹39</span> with{" "}
              <span style={{ fontWeight: "bold" }}>TriBe</span>
            </Text>
          </Box>
          ...
          <Box
            ...
            alignItems="center"
          >
            <Text letterSpacing={1} fontSize="sm" p="1" pl="3">
          ...
          <Box mt="4" border="1px solid #e2dede">
            ...
            >
              <Box pl="2">
                <Text>Apply Coupon / Gift Card / Referral</Text>
              </Box>
              <Box pr="2">
                <Text>Redeem </Text>
              </Box>
            ...
            <Box border="1px solid #e2dede" p="2" bg="#ebebeb" mt="1" mb="4">
              <Text as="b" fontSize="12" letterSpacing={0.5} ml="2">
                PRICE SUMMARY
              </Text>
            </Box>
            <Box
